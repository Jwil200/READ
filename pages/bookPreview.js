...
const toggleFavorite = async () => {
  ...
  return (
    ...
    <View style={styles.progress}>
        <Text style={[styles.bookPreviewProgress, { color: dynamicStyles.color }]}>Progress:</Text>
       <ProgressButton 
    ...
    <Divider />
    <Text style={[styles.statText2, { color: dynamicStyles.color }]}>🏆 Achievements For {book.title}: </Text>
   
      <Text style={[styles.statText2, { color: dynamicStyles.color }]}>📖 Words Read: {book.wordCount} </Text> 
      <Text style={[styles.statText2, { color: dynamicStyles.color }]}>⏰ Time Read: {book.timeRead} </Text>
